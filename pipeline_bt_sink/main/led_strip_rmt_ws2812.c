...
//这里时间必须要改，因为用的是ws2812而不是ws2812b！！！坑死了
#define WS2812_T0H_NS (350)//(350)
#define WS2812_T0L_NS (800)//(1000)
#define WS2812_T1H_NS (700)//(1000)
#define WS2812_T1L_NS (600)//(350)b
#define WS2812_RESET_US (60)//(280)
